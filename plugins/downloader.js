...
smd({
  ...
  try {
    ...
    let _0x4737bb = {
      audio: _0x2ba501,
      fileName: "W O L F tiktok Sound" + _0x19c223 + ".m4a",
      mimetype: "audio/mpeg",
      ptt: true,
...
smd(
  ...
  async (m, url) => {
    try {
      ...
      const caption = `『 *W O L F • MEDIAFIRE DOWNLOADER* 』\n\n *Name* : ${result.name}\n *Size* : ${result.size}\n *Mime* : ${result.mime}\n\n\n${Config.caption}`;
...
smd({
  ...
  try {
    ...
    let _0x300d1a = {
      ...
      mimetype: "audio/mpeg",
      fileName: "W O L F--" + _0x1d542b[1] + ".mp3",
      caption: Config.caption,
...
cmd({
  ...
  if (_0xb75e78.quoted && _0xb75e78.text) {
    ...
    if (_0x5b8ee5[0].includes("W O L F • SONG DOWNLOADER")) {
    ...
    } else if (_0x5b8ee5[0].includes("W O L F • YOUTUBE DOWNLOADER")) {
    ...
    } else if (_0x5b8ee5[0].includes("W O L F • APK DOWNLOAD LIST")) {
