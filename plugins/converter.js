...
smd({
  ...
  try {
    ...
    let _0x20f704 = _0x44d3dd[1] && _0x44d3dd[1] !== "" ? _0x44d3dd[1] : "W O L F🐺";
...
smd({
  ...
  try {
    let _0x365550 = "┏━━━━━━━━━━━━━━━━━━━━━━━━\n┃\t*💬 W O L F _FANCY_TEXT💬* \n┗━━━━━━━━━━━━━━━━━━━━━━━━\n\n " + (_0x3b568a ? "```🔢Reply the number you wants to select``` \n\n" : "```\t\t" + prefix + "W O L F (For all text)\n\t\t" + prefix + "fancy 25 W O L F(For specific text)```\n\n");
    let _0x50c7d9 = parseInt(_0x3b568a);
    if (isNaN(_0x50c7d9)) {
      let _0x4ca942 = _0x3b568a ? _0x3b568a : " W O L F";
...
smd({
  ...
  try {
    ...
    if (!_0xd51ec) {
      return _0x4cfc4e.reply("*_Example : " + prefix + "fliptext W O L F!_*");
    }
...
smd({
  ...
  try {
    ...
    if (_0x2cee76) {
      ...
      return _0x54e3dc.reply("*_Uhh Dear, provide text, ex .ttp 4 hii im W O L F!!_*");
    }
  } catch (_0x72e5d) {
